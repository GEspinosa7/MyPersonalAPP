            ...
            child: Center(
              child: Column(
                ...
                children: [
                    ...
                    margin: EdgeInsets.fromLTRB(10, 20, 10, 20), 
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Valor dos Serviços: RS " + trainerProfile.price, style: TextStyle(fontSize: 16),)
                        ],
                      ),
                  ),
                  Divider(),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Column(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: <Widget>[
                              Text('Tempo de Profissão', style: TextStyle(fontSize: 18, color: mainBlack, fontWeight: FontWeight.bold),),
                              Text('Idade', style: TextStyle(fontSize: 18, color: mainBlack, fontWeight: FontWeight.bold),),
                            ],
                          ),
                          Column(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                  ...
                  profissionalDatas(title: 'Qualificações', result: trainerProfile.qualifications),
                  profissionalDatas(title: 'Disponibilidade Atual', result: trainerProfile.availability),
                  Divider(),
                  Container(
