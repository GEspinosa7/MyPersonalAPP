                ...
                children: [
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: <Widget>[
                                    Text(widget.client.toString(), style: TextStyle(fontSize: 16),),
                                    Text(widget.client.toString(), style: TextStyle(fontSize: 16),),
                  ...
                  Container(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            Text('Treino Atual', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                            Divider(),
                            Container(
                              child: Text('sem treino', style: TextStyle(fontSize: 15),)
                            )
                          ],
                        )
                      ),
