...
class _MyTainerProfileState extends State<MyTainerProfile> {
  ...
  _loadContract() async {
    final resp = await service.getContract();
    setState(() {
      contract = resp;
    });
  }
  ...
  Widget build(BuildContext context) {
    return contract == null ? normalLoad() : Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text('Contrato',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                        Divider(),
                        Container(
                          width: double.infinity,
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: <Widget>[
                                    Text('Data de Início', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold),),
                                    Text('Data de Fim', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold),),
                                    Text('Tempo Contratado', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold),),
                                ...
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: <Widget>[
                                    Text(contract.startDate.toString(), style: TextStyle(fontSize: 16),),
                                    Text(contract.closeDate.toString(), style: TextStyle(fontSize: 16),),
                                    Text("closeDate - today", style: TextStyle(fontSize: 16),),
                  ...
                  Container(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: <Widget>[
                            Text('Disponibilidade Atual', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                            Divider(),
                            Container(
                              child: Text(contract.trainer.availability.toString(), style: TextStyle(fontSize: 15),)
                            )
                          ],
                        )
                      ),
